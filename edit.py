...
def complete_connection_flow():
    with sync_playwright() as p:
        ...
        try:
            ...
            standalone_selectors = ["text=Standalone", "label:has-text('Standalone')", "div:has-text('Standalone')"]
            ...
            # Embedded App URL
            if page.locator("input[name='embeddedAppUrl']").count() > 0:
                page.fill("input[name='embeddedAppUrl']", "http://localhost:5173/integrations/add")
